...
using static GameMethods.Exceptions;
...
namespace GameMethods
{
    ...
    public class Game
    {
        ...
        /// </summary>
        List<ICheckWinAlgorithm> winningCheckAlgorithms = null;
        ...
        public Game(int Height, int Width)
        {
            ...
            this.winningCheckAlgorithms = new List<ICheckWinAlgorithm>();
        ...
        /// <summary>
        /// Resets the board and re-initializes the game.
        /// </summary>
        public void Reset()
        {
            _Board.Dispose();
        ...
        public void AddDisc(Disc disc, int RowIndex)
        {
            ...
            if (!CheckWin()) // Need to switch the sides that are currently playing around
            {
